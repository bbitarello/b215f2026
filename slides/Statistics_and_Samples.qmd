...
![Cover from "The Economist" (Feb 27-March 10, 2010)](images/datadeluge.png){fig-alt="Cover of the magazine “The economist”. The heading reads: “The data deluge - And how to handle it: A 14-page special report”. Under the heading is a drawing of a person holding an umbrella in a rainstorm, but the rain is all 1s and 0s. The umbrella top is open but upside-down, collecting water which the person is using to water a plant from the handle of the umbrella." width="460"}

## Challenge: understanding

![From: https://xkcd.com/1478/](images/pvaluexkcd.png){fig-alt="Comic from xfcd.com: lists p-values ranging from 0.001 to >=0.1 on the left, and on the right offers and interpretation." width="467"}
...
![](images/xfiles.png){fig-align="center" width="605"}
...
::: column
![](images/starfish2.png){width="449"}
:::
:::::
...
::::: columns
::: {.column width="\"50%\""}
![Republican Alf Landon](https://upload.wikimedia.org/wikipedia/commons/c/c6/Alf_Landon_closeupcrop.jpg){width="244"}
:::

::: {.column width="\"50%\""}
![Democrat Franklin Roosevelt](https://upload.wikimedia.org/wikipedia/commons/3/37/FDR_and_Fala_at_table.jpg){width="206"}
:::
:::::
::::::
