...
* Familiarity with statistical and probabilistic thinking, concepts, and common misconceptions.
* Ability to turn biological questions into testable hypothesis.
* Ability to judge the validity of a stated conclusion by examining the data, statistical tests, and result that provide its basis.
* Ability to navigate complex data structures and to understand the nature of the data at hand.
* Ability to judge data types and explore and visualize it in R accordingly.
* Ability to carry out several statistical analyses in R.
* Ability to make reports in Rmarkdown including data exploration, visualization, and analysis.
* An appreciation, rather than fear, of the mathematical expression of statistical concepts.
...
**Lectures**: Introduce statistical concepts and address questions based on the assigned readings. In-class activities will occur often and count towards participation. Lectures are designed with the assumption that you have completed the pre-assigned readings and pre-recorded lecture videos, enabling us to dive deeper into nuances, applications, and questions.

**Labs**: R computer lab (bring your laptop) with guided tutorial. R Labs are due by the end of the day.

Problem sets and coding assignments are typically due on Fridays (but always check case by case). Moodle check-ins are typically due weekly on Sundays (soft deadline) though you may retake them later until the hard deadlines (see [Schedule](schedule.qmd)).
...
|:--------------------|:----------------|
| Participation       | $5$%            |
| DataCamp and Weekly labs  | $12$%     |
| Problem sets (4)    | $16$ |
| Coding project (part I) | $5$         |
| Coding assignment 2 <br> Coding Interview <br> Final report| $13$% <br> $6$ <br> $7%$      |
| Midterm 1           | $30$%           |
| Midterm 2           | $30$%           |
